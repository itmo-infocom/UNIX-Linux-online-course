...
Double quoted string means partial quoting. This disables the interpretation of word separator characters within STRING - the entire string with spaces appears as one parameter to the command.

Single quoted string interpreted as a full quoting. Such quoting preserves all special characters within STRING. This is a stronger form of quoting than double quoting.
...
Asterisk used when a filename is expected. It matches any filename except those starting with a dot (or any
part of a filename, except the initial dot).
