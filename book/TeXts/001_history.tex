...
\includegraphics[scale=0.3]{figs/I_Newton.jpg}
\end{minipage}}
...
\medskip
\hbox{\begin{minipage}[b]{0.2\linewidth}\includegraphics[scale=0.125]{figs/Multics.png}
\end{minipage}
...
\end{minipage}\hspace{1em}
\begin{minipage}[b]{0.32\linewidth}\includegraphics[scale=0.18]{figs/thompson_ritchie.jpeg}
\end{minipage}
}

\medskip
\hbox{\begin{minipage}[b]{0.5\linewidth}\includegraphics[scale=0.1]{figs/Pdp7-oslo-2005.jpeg}
\end{minipage}\hspace{1em}
...
assembler was not
\end{minipage}\hspace{1em}
\begin{minipage}[t]{0.35\linewidth}\includegraphics[scale=0.18]{figs/chess.jpeg}
\end{minipage}
}
